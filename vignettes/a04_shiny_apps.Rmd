...
As shown in the [Styles](a05_style.html) vignette, **visOmopResults** allows tables and plots to be styled consistently using a `_brand.yml` file. The same styling can be used when displaying results in a Shiny application.
...
For details on defining a brand, customising styles, and applying styles globally to tables and plots, see the [Styles](a05_style.html) vignette.
