...
To use the Calibri font family for plots you will need to have the font installed, and for **Windows** registered in R graphics. See the [Styles](a03_style.html) vignette.
...
# Load mock results stored in the package ----
reportData <- visOmopResults::data
...
For tables we choose the `"flextable"` type because it renders best to Word documents.
To use the Calibri font family for plots you will need to have the font installed. See the [Styles](a03_style.html) vignette.
...
You can access an example Quarto script and the reference DOCX document [here](https://github.com/darwin-eu/visOmopResults/tree/main/inst/quarto).
