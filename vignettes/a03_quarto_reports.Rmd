...
To use the Calibri font family for plots you will need to have the font installed, and for **Windows** registered in R graphics. See the [Styles](a05_style.html) vignette.
...
To use the Calibri font family for plots you will need to have the font installed. See the [Styles](a05_style.html) vignette.
