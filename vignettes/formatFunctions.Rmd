...
Additional options can be specified in the `.options` argument. These options are taken from the other format functions and gt/fx table functions seen before. To see a list of allowed arguments and their default values use `optionsFormatTable()`:
