test_that("splitGroup", {
  ...
  expect_true(all(res2$age[!is.na(res2$age)] == res3$age[!is.na(res2$age)]))
  expect_true(all(res2$sex[!is.na(res2$sex)] == res3$sex[!is.na(res2$sex)]))
  expect_true(all(res3$age[is.na(res2$age)] == "Any"))
  expect_true(all(res3$sex[is.na(res2$sex)] == "Any"))
})
