...
format:
  docx:
    reference-doc: darwinReportRef.docx
...
# Load data ----
reportData <- here::here("inst", "mockData", "mockReportData.RData")
load(reportData)
...
knitr::opts_chunk$set(
  ...
  fig.width  = 6,      # fix width-height aspect ratio, but it can be modified for specific figures
  fig.height = 3,
